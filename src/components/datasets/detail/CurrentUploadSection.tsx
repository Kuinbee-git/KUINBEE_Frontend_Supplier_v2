        ...
        <div className="flex items-center gap-2">
          ...
          <div className="text-left">
            ...
            <p className="text-xs" style={{ color: tokens.textMuted }}>
              {currentUpload ? `Status: ${currentUpload.status}` : 'No upload yet'}
            </p>
          </div>
        </div>
        {isExpanded ? (
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span
                    ...
                    style={{
                      background:
                        currentUpload.status === 'UPLOADED' ? 'rgba(34, 197, 94, 0.1)' :
                          currentUpload.status === 'UPLOADING' ? 'rgba(234, 179, 8, 0.1)' :
                            currentUpload.status === 'FAILED' ? 'rgba(239, 68, 68, 0.1)' :
                              'rgba(59, 130, 246, 0.1)',
                      color:
                        currentUpload.status === 'UPLOADED' ? '#22c55e' :
                          currentUpload.status === 'UPLOADING' ? '#eab308' :
                            currentUpload.status === 'FAILED' ? '#ef4444' :
                              '#3b82f6',
                    }}
                  >
