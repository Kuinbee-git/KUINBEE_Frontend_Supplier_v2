      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <span
            ...
            style={{
              background:
                PRICING_STATUS_CONFIG[pricingData.status]?.bgColor || "#f3f4f6",
              color:
                PRICING_STATUS_CONFIG[pricingData.status]?.color || "#6b7280",
              border: `1.5px solid ${
          ...
          >
            <span className="mr-1.5">
              {PRICING_STATUS_CONFIG[pricingData.status]?.icon}
            </span>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p
                    ...
                    style={{ color: isDark ? "#eab308" : "#b45309" }}
                  >
                  ...
                  <div className="space-y-3">
                    ...
                    <p
                      ...
                      style={{ color: tokens.textSecondary }}
                    >
                      Please review the feedback above and update your pricing
                      before resubmitting.
                    </p>
                  </div>
                </div>
          ...
          >
            ...
            >
              ...
              {pricingData.status === "DRAFT" &&
                "💾 Your pricing is saved as draft. Review and submit it when ready."}
              {pricingData.status === "SUBMITTED" &&
                "📤 Your pricing is submitted and under admin review."}
              {pricingData.status === "CHANGES_REQUESTED" &&
                "✏️ Admin has requested changes. Make edits and resubmit."}
              {pricingData.status === "RESUBMITTED" &&
                "📤 Your updated pricing is under review."}
              {pricingData.status === "UNDER_REVIEW" &&
                "👀 Your pricing is being reviewed by admin."}
              {pricingData.status === "ACTIVE" &&
                "✅ Your pricing is active and live."}
              {pricingData.status === "REJECTED" &&
                "❌ Your pricing was rejected. Edit and resubmit."}
              {pricingData.status === "INACTIVE" &&
                "🔒 Your pricing is currently inactive."}
            </p>
          </div>
