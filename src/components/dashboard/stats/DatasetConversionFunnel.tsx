  ...
  if (loading) {
    return (
      <div
        ...
        style={{ background: "var(--muted)", height: "180px" }}
      />
    );
  }

  const conversionPercent = dataset.conversionRate * 100;
  const conversionWidth = Math.min(Math.max(conversionPercent, 8), 100);
      ...
      <div>
        ...
        >
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, rgba(74, 144, 226, 0.4), rgba(74, 144, 226, 0.8))",
              width: "100%",
            }}
          >
