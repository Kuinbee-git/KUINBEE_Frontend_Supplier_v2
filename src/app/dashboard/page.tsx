        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-7">
          ...
          <StatCard 
            ...
            value={
              isComplete ? (
                <span 
                  className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-base font-semibold"
                  style={{ 
                    background: tokens.successBg, 
                    color: tokens.successText 
                  }}
                >
                  <svg width="18" height="18" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="10" cy="10" r="10" fill={tokens.successText}/><path d="M7.5 10.5L9.5 12.5L13 9" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
                  Complete
                </span>
              ) : (
                <span style={{ color: tokens.textMuted }}>Pending</span>
              )
            }
            className="p-5"
          />
          ...
          <div className="p-5">
            ...
            <Button
              ...
              style={{
                ...
                boxShadow: '0 2px 8px rgba(42,53,88,0.10)',
              }}
            >
            ...
            <div>
              <div className="space-y-3 max-h-72 overflow-y-auto pr-2">
                {proposals.map((proposal) => (
                  <div
                    key={proposal.id}
                    className="p-4 rounded-lg border transition-all duration-300 cursor-pointer hover:scale-102 hover:shadow-lg"
                    style={{
